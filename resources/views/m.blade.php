...
@section('content')
    <div class="container">
        ...
        <section class="shad side">
            ...
            <div>
                <h3>الحساب</h2>
                    <span onclick="s('.login').classList.remove('hidden');s('body').classList.add('unscrolable');"><i
                            class="fal fa-sign-in"></i> دخول </span>
                    <span onclick="s('.signup').classList.remove('hidden');s('body').classList.add('unscrolable');"><i
