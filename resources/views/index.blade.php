...
@section('content')
    <div class="container">
        <section class="shad side">
            ...
            <div>
                <h3>الحساب</h2>
                    <span onclick="s('.login').classList.remove('hidden');s('body').classList.add('unscrolable');esc()"><i
                            class="fal fa-sign-in"></i> دخول </span>
                    <span onclick="s('.signup').classList.remove('hidden');s('body').classList.add('unscrolable');esc()"><i
                            class="fal fa-plus-square"></i> جديد </span>
            </div>

            <div class="hidden closed closed1">
            ...
            <div class="closed closed1">
                <h3 onclick="closetgl(this)"> <i class="fal fa-chevron-up"></i> المعروض</h2>
        ...
        <section class="QMcontainer">
            ...
            <section class="Mcontainer">
                <h2>المتسلسلات المضافة حديثا</h2>
                @foreach ($motasalselat as $qessa)
                    @include('components.book', ['qessa' => $qessa])
                @endforeach
            @endsection
